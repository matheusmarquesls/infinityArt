    ...
    poolBancoDados = mysql.createPool(
        {
            ...
            host: '10.18.36.15',
            user: 'admin',//USUARIO_DO_BANCO_LOCAL
            password: 'JP2005ma_',
    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            await poolBancoDados.execute(
                ...
                'INSERT INTO leituras (dht11_umidade, dht11_temperatura, ldr_lux, fkSensor) VALUES (?, ?, ?, 1)',
                [dht11Umidade, dht11Temperatura, luminosidade],
                
            );
            await poolBancoDados.execute(

                'INSERT INTO leituras (dht11_umidade, dht11_temperatura, ldr_lux, fkSensor) VALUES (?, ?, ?, 2)',
                [dht11Umidade2, dht11Temperatura2, luminosidade2],
